...
class gluster::server(
	...
	file { "${vardir}/sponge.py":		# for scripts needing: 'sponge'
		...
		owner => "${::gluster::params::misc_owner_server_sponge_file}",
		group => "${::gluster::params::misc_group_server_sponge_file}",
		mode => 700,			# u=rwx
	...
	file { '/etc/glusterfs/':
		...
		owner => "${::gluster::params::misc_owner_server_glusterfs_dir}",
		group => "${::gluster::params::misc_group_server_glusterfs_dir}",
		mode => 644,
	...
	file { '/etc/glusterfs/glusterd.vol':
		...
		owner => "${::gluster::params::misc_owner_server_glusterd_vol_file}",
		group => "${::gluster::params::misc_group_server_glusterd_vol_file}",
		mode => 644,			# u=rw,go=r
		ensure => present,
	...
	file { '/var/lib/glusterd/':
		...
		purge => false,			# TODO: eventually...
		force => false,			# TODO: eventually...
		owner => "${::gluster::params::misc_owner_server_glusterd_dir}",
		group => "${::gluster::params::misc_group_server_glusterd_dir}",
		mode => 644,
	...
	file { '/var/lib/glusterd/peers/':
		...
		purge => true,
		force => true,
		owner => "${::gluster::params::misc_owner_server_peers_file}",
		group => "${::gluster::params::misc_group_server_peers_file}",
		mode => 644,
